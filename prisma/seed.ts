...
async function main() {
  ...
  const maisonMargiela = await prisma.fragranceHouse.upsert({ where: { name: 'Maison Margiela' }, update: {}, create: { name: 'Maison Margiela', tier: 'niche', country: 'France', founded: 1988 } })
  ...
  const lancome = await prisma.fragranceHouse.upsert({ where: { name: 'Lancôme' }, update: {}, create: { name: 'Lancôme', tier: 'designer', country: 'France', founded: 1935 } })
  ...
  const louisVuitton = await prisma.fragranceHouse.upsert({ where: { name: 'Louis Vuitton' }, update: {}, create: { name: 'Louis Vuitton', tier: 'designer', country: 'France', founded: 1854 } })
  const kilian = await prisma.fragranceHouse.upsert({ where: { name: 'Kilian' }, update: {}, create: { name: 'Kilian', tier: 'niche', country: 'France', founded: 2007 } })
  const emporioArmani = await prisma.fragranceHouse.upsert({ where: { name: 'Emporio Armani' }, update: {}, create: { name: 'Emporio Armani', tier: 'designer', country: 'Italy', founded: 1975 } })
  const givenchy = await prisma.fragranceHouse.upsert({ where: { name: 'Givenchy' }, update: {}, create: { name: 'Givenchy', tier: 'designer', country: 'France', founded: 1952 } })
  ...
  const cognac = await prisma.note.upsert({ where: { name: 'Cognac' }, update: {}, create: { name: 'Cognac', family: 'oriental' } })
  const praline = await prisma.note.upsert({ where: { name: 'Praline' }, update: {}, create: { name: 'Praline', family: 'gourmand' } })
  const oak = await prisma.note.upsert({ where: { name: 'Oak' }, update: {}, create: { name: 'Oak', family: 'woody' } })
  const marine = await prisma.note.upsert({ where: { name: 'Marine' }, update: {}, create: { name: 'Marine', family: 'fresh' } })
  const aldehydes = await prisma.note.upsert({ where: { name: 'Aldehydes' }, update: {}, create: { name: 'Aldehydes', family: 'fresh' } })
  const juniper = await prisma.note.upsert({ where: { name: 'Juniper' }, update: {}, create: { name: 'Juniper', family: 'woody' } })
  const whiteMusk = await prisma.note.upsert({ where: { name: 'White Musk' }, update: {}, create: { name: 'White Musk', family: 'woody' } })
  const ambergris = await prisma.note.upsert({ where: { name: 'Ambergris' }, update: {}, create: { name: 'Ambergris', family: 'oriental' } })
  const rosemary = await prisma.note.upsert({ where: { name: 'Rosemary' }, update: {}, create: { name: 'Rosemary', family: 'aromatic' } })
  const artemisia = await prisma.note.upsert({ where: { name: 'Artemisia' }, update: {}, create: { name: 'Artemisia', family: 'aromatic' } })
  const pinkPepper = await prisma.note.upsert({ where: { name: 'Pink Pepper' }, update: {}, create: { name: 'Pink Pepper', family: 'spicy' } })
  const violet = await prisma.note.upsert({ where: { name: 'Violet' }, update: {}, create: { name: 'Violet', family: 'floral' } })
  const hyacinth = await prisma.note.upsert({ where: { name: 'Hyacinth' }, update: {}, create: { name: 'Hyacinth', family: 'floral' } })
  const clarySage = await prisma.note.upsert({ where: { name: 'Clary Sage' }, update: {}, create: { name: 'Clary Sage', family: 'aromatic' } })
  const honey = await prisma.note.upsert({ where: { name: 'Honey' }, update: {}, create: { name: 'Honey', family: 'gourmand' } })
  const fruityNotes = await prisma.note.upsert({ where: { name: 'Fruity Notes' }, update: {}, create: { name: 'Fruity Notes', family: 'fruity' } })
  const sicilianOrange = await prisma.note.upsert({ where: { name: 'Sicilian Orange' }, update: {}, create: { name: 'Sicilian Orange', family: 'citrus' } })
  ...
  const replica = await prisma.fragrance.upsert({ where: { slug: 'maison-margiela-by-the-fireplace' }, update: {}, create: { houseId: maisonMargiela.id, name: 'By the Fireplace', slug: 'maison-margiela-by-the-fireplace', concentration: 'EDT', yearReleased: 2015, retailPriceUsd: 175, sizeMl: 100, gender: 'unisex', season: ['fall', 'winter'], occasion: ['casual', 'evening'], longevity: 7, sillage: 6, description: 'Chestnut, guaiac wood, and vanilla — the smell of sitting by a fire.' } })
  ...
  const idole = await prisma.fragrance.upsert({ where: { slug: 'lancome-idole-edp' }, update: {}, create: { houseId: lancome.id, name: 'Idôle', slug: 'lancome-idole-edp', concentration: 'EDP', yearReleased: 2019, retailPriceUsd: 110, sizeMl: 100, gender: 'feminine', season: ['spring', 'summer'], occasion: ['casual', 'office'], longevity: 7, sillage: 6, description: 'Rose and jasmine with a clean musk base — modern and feminine.' } })
  ...
  const lvImagination = await prisma.fragrance.upsert({ where: { slug: 'lv-imagination' }, update: {}, create: { houseId: louisVuitton.id, name: 'Imagination', slug: 'lv-imagination', concentration: 'EDT', yearReleased: 2019, retailPriceUsd: 305, sizeMl: 100, gender: 'masculine', season: ['spring', 'summer'], occasion: ['casual', 'office'], longevity: 6, sillage: 3, description: 'A bright aquatic citrus with mineral undertones — fresh, clean, and effortlessly refined.' } })
  const lvImmensite = await prisma.fragrance.upsert({ where: { slug: 'lv-immensite' }, update: {}, create: { houseId: louisVuitton.id, name: "L'Immensite", slug: 'lv-immensite', concentration: 'EDT', yearReleased: 2021, retailPriceUsd: 305, sizeMl: 100, gender: 'masculine', season: ['spring', 'summer'], occasion: ['casual', 'office'], longevity: 7, sillage: 4, description: 'Crisp grapefruit and ginger over a smooth woody base — an expansive, sky-like freshness.' } })
  const angelsShare = await prisma.fragrance.upsert({ where: { slug: 'kilian-angels-share' }, update: {}, create: { houseId: kilian.id, name: "Angels' Share", slug: 'kilian-angels-share', concentration: 'EDP', yearReleased: 2019, retailPriceUsd: 295, sizeMl: 50, gender: 'unisex', season: ['fall', 'winter'], occasion: ['date', 'evening'], longevity: 9, sillage: 5, description: 'Cognac, cinnamon, and oak — inspired by the portion of whiskey lost to evaporation during aging.' } })
  const strongerAbsolutely = await prisma.fragrance.upsert({ where: { slug: 'emporio-armani-stronger-with-you-absolutely' }, update: {}, create: { houseId: emporioArmani.id, name: 'Stronger With You Absolutely', slug: 'emporio-armani-stronger-with-you-absolutely', concentration: 'Parfum', yearReleased: 2021, retailPriceUsd: 120, sizeMl: 100, gender: 'masculine', season: ['fall', 'winter'], occasion: ['date', 'evening'], longevity: 10, sillage: 6, description: 'An intensified, darker take on Stronger With You — cardamom and vanilla pushed to parfum intensity.' } })
  const burberryTouch = await prisma.fragrance.upsert({ where: { slug: 'burberry-touch-edt' }, update: {}, create: { houseId: burberry.id, name: 'Touch', slug: 'burberry-touch-edt', concentration: 'EDT', yearReleased: 2000, retailPriceUsd: 85, sizeMl: 100, gender: 'masculine', season: ['spring', 'fall'], occasion: ['casual', 'office'], longevity: 6, sillage: 3, description: 'White pepper, cedar, and artemisia — a clean, quiet masculine with understated sophistication.' } })
  const givenchyGentleman = await prisma.fragrance.upsert({ where: { slug: 'givenchy-gentleman-edp' }, update: {}, create: { houseId: givenchy.id, name: 'Gentleman', slug: 'givenchy-gentleman-edp', concentration: 'EDP', yearReleased: 2018, retailPriceUsd: 110, sizeMl: 100, gender: 'masculine', season: ['fall', 'winter'], occasion: ['office', 'date'], longevity: 8, sillage: 4, description: 'Iris and patchouli anchored by a warm vanilla base — refined masculinity with an edge.' } })
  const versacePourHomme = await prisma.fragrance.upsert({ where: { slug: 'versace-pour-homme-edt' }, update: {}, create: { houseId: versace.id, name: 'Pour Homme', slug: 'versace-pour-homme-edt', concentration: 'EDT', yearReleased: 2005, retailPriceUsd: 85, sizeMl: 100, gender: 'masculine', season: ['spring', 'summer'], occasion: ['casual', 'office'], longevity: 6, sillage: 3, description: 'Citrus, neroli, and hyacinth over a Mediterranean-inspired woody base — clean and timeless.' } })
  const bleuChanelEdt = await prisma.fragrance.upsert({ where: { slug: 'chanel-bleu-de-chanel-edt' }, update: {}, create: { houseId: chanel.id, name: 'Bleu de Chanel', slug: 'chanel-bleu-de-chanel-edt', concentration: 'EDT', yearReleased: 2010, retailPriceUsd: 155, sizeMl: 100, gender: 'masculine', season: ['spring', 'summer', 'fall'], occasion: ['office', 'casual'], longevity: 7, sillage: 4, description: 'Lighter and fresher than the EDP — citrus and grapefruit over a clean woody base.' } })
  const xerjoffErbaPuraGold = await prisma.fragrance.upsert({ where: { slug: 'xerjoff-erba-pura-gold' }, update: {}, create: { houseId: xerjoff.id, name: 'Erba Pura Gold', slug: 'xerjoff-erba-pura-gold', concentration: 'EDP', yearReleased: 2022, retailPriceUsd: 190, sizeMl: 50, gender: 'unisex', season: ['spring', 'summer'], occasion: ['casual', 'date'], longevity: 8, sillage: 6, description: 'A golden, sun-drenched take on Erba Pura — citrus and white musk with added warmth and depth.' } })
  const erosFlame = await prisma.fragrance.upsert({ where: { slug: 'versace-eros-flame-edp' }, update: {}, create: { houseId: versace.id, name: 'Eros Flame', slug: 'versace-eros-flame-edp', concentration: 'EDP', yearReleased: 2018, retailPriceUsd: 110, sizeMl: 100, gender: 'masculine', season: ['fall', 'winter'], occasion: ['date', 'evening'], longevity: 8, sillage: 5, description: 'Lemon, pepper, and rosemary over a warm base of sandalwood and vanilla — Eros gone darker and more seductive.' } })
  ...
  await prisma.discounterPrice.upsert({ where: { fragranceId_discounterId: { fragranceId: angelsShare.id, discounterId: fragranceX.id } }, update: {}, create: { fragranceId: angelsShare.id, discounterId: fragranceX.id, priceUsd: 189, affiliateUrl: 'https://www.fragrancex.com/products/_cid_perfume-am-lid_A-am-pid_90234w' } })
  await prisma.discounterPrice.upsert({ where: { fragranceId_discounterId: { fragranceId: strongerAbsolutely.id, discounterId: fragranceX.id } }, update: {}, create: { fragranceId: strongerAbsolutely.id, discounterId: fragranceX.id, priceUsd: 82, affiliateUrl: 'https://www.fragrancex.com/products/_cid_perfume-am-lid_S-am-pid_91234w' } })
  await prisma.discounterPrice.upsert({ where: { fragranceId_discounterId: { fragranceId: burberryTouch.id, discounterId: fragranceX.id } }, update: {}, create: { fragranceId: burberryTouch.id, discounterId: fragranceX.id, priceUsd: 52, affiliateUrl: 'https://www.fragrancex.com/products/_cid_perfume-am-lid_B-am-pid_12345w' } })
  await prisma.discounterPrice.upsert({ where: { fragranceId_discounterId: { fragranceId: givenchyGentleman.id, discounterId: fragranceX.id } }, update: {}, create: { fragranceId: givenchyGentleman.id, discounterId: fragranceX.id, priceUsd: 72, affiliateUrl: 'https://www.fragrancex.com/products/_cid_perfume-am-lid_G-am-pid_23456w' } })
  await prisma.discounterPrice.upsert({ where: { fragranceId_discounterId: { fragranceId: versacePourHomme.id, discounterId: fragranceX.id } }, update: {}, create: { fragranceId: versacePourHomme.id, discounterId: fragranceX.id, priceUsd: 48, affiliateUrl: 'https://www.fragrancex.com/products/_cid_perfume-am-lid_V-am-pid_34567w' } })
  await prisma.discounterPrice.upsert({ where: { fragranceId_discounterId: { fragranceId: erosFlame.id, discounterId: fragranceX.id } }, update: {}, create: { fragranceId: erosFlame.id, discounterId: fragranceX.id, priceUsd: 68, affiliateUrl: 'https://www.fragrancex.com/products/_cid_perfume-am-lid_E-am-pid_45678w' } })
  await prisma.discounterPrice.upsert({ where: { fragranceId_discounterId: { fragranceId: xerjoffErbaPuraGold.id, discounterId: fragranceX.id } }, update: {}, create: { fragranceId: xerjoffErbaPuraGold.id, discounterId: fragranceX.id, priceUsd: 132, affiliateUrl: 'https://www.fragrancex.com/products/_cid_perfume-am-lid_X-am-pid_56789w' } })
  ...
  await linkNote(lvImagination.id, aldehydes.id, 'top')
  await linkNote(lvImagination.id, marine.id, 'heart')
  await linkNote(lvImagination.id, iris.id, 'heart')
  await linkNote(lvImagination.id, whiteMusk.id, 'base')
  await linkNote(lvImagination.id, cedar.id, 'base')

  await linkNote(lvImmensite.id, grapefruit.id, 'top')
  await linkNote(lvImmensite.id, ginger.id, 'top')
  await linkNote(lvImmensite.id, cardamom.id, 'heart')
  await linkNote(lvImmensite.id, juniper.id, 'heart')
  await linkNote(lvImmensite.id, cedar.id, 'base')
  await linkNote(lvImmensite.id, sandalwood.id, 'base')

  await linkNote(angelsShare.id, cognac.id, 'top')
  await linkNote(angelsShare.id, cinnamon.id, 'top')
  await linkNote(angelsShare.id, praline.id, 'heart')
  await linkNote(angelsShare.id, tonkaBean.id, 'heart')
  await linkNote(angelsShare.id, oak.id, 'base')
  await linkNote(angelsShare.id, vanilla.id, 'base')

  await linkNote(strongerAbsolutely.id, cardamom.id, 'top')
  await linkNote(strongerAbsolutely.id, pinkPepper.id, 'top')
  await linkNote(strongerAbsolutely.id, sage.id, 'heart')
  await linkNote(strongerAbsolutely.id, violet.id, 'heart')
  await linkNote(strongerAbsolutely.id, vanilla.id, 'base')
  await linkNote(strongerAbsolutely.id, tonkaBean.id, 'base')
  await linkNote(strongerAbsolutely.id, oakmoss.id, 'base')

  await linkNote(burberryTouch.id, artemisia.id, 'top')
  await linkNote(burberryTouch.id, pepper.id, 'top')
  await linkNote(burberryTouch.id, geranium.id, 'heart')
  await linkNote(burberryTouch.id, cedar.id, 'base')
  await linkNote(burberryTouch.id, amber.id, 'base')

  await linkNote(givenchyGentleman.id, bergamot.id, 'top')
  await linkNote(givenchyGentleman.id, pepper.id, 'top')
  await linkNote(givenchyGentleman.id, iris.id, 'heart')
  await linkNote(givenchyGentleman.id, geranium.id, 'heart')
  await linkNote(givenchyGentleman.id, patchouli.id, 'base')
  await linkNote(givenchyGentleman.id, vanilla.id, 'base')
  await linkNote(givenchyGentleman.id, cedar.id, 'base')

  await linkNote(versacePourHomme.id, lemon.id, 'top')
  await linkNote(versacePourHomme.id, bergamot.id, 'top')
  await linkNote(versacePourHomme.id, neroli.id, 'top')
  await linkNote(versacePourHomme.id, hyacinth.id, 'heart')
  await linkNote(versacePourHomme.id, clarySage.id, 'heart')
  await linkNote(versacePourHomme.id, cedar.id, 'base')
  await linkNote(versacePourHomme.id, tonkaBean.id, 'base')

  await linkNote(bleuChanelEdt.id, grapefruit.id, 'top')
  await linkNote(bleuChanelEdt.id, lemon.id, 'top')
  await linkNote(bleuChanelEdt.id, mint.id, 'top')
  await linkNote(bleuChanelEdt.id, ginger.id, 'heart')
  await linkNote(bleuChanelEdt.id, nutmeg.id, 'heart')
  await linkNote(bleuChanelEdt.id, incense.id, 'base')
  await linkNote(bleuChanelEdt.id, vetiver.id, 'base')
  await linkNote(bleuChanelEdt.id, cedar.id, 'base')

  await linkNote(xerjoffErbaPuraGold.id, sicilianOrange.id, 'top')
  await linkNote(xerjoffErbaPuraGold.id, grapefruit.id, 'top')
  await linkNote(xerjoffErbaPuraGold.id, lemon.id, 'top')
  await linkNote(xerjoffErbaPuraGold.id, fruityNotes.id, 'heart')
  await linkNote(xerjoffErbaPuraGold.id, whiteMusk.id, 'base')
  await linkNote(xerjoffErbaPuraGold.id, ambergris.id, 'base')
  await linkNote(xerjoffErbaPuraGold.id, sandalwood.id, 'base')

  await linkNote(erosFlame.id, lemon.id, 'top')
  await linkNote(erosFlame.id, pepper.id, 'top')
  await linkNote(erosFlame.id, rosemary.id, 'top')
  await linkNote(erosFlame.id, geranium.id, 'heart')
  await linkNote(erosFlame.id, neroli.id, 'heart')
  await linkNote(erosFlame.id, sandalwood.id, 'base')
  await linkNote(erosFlame.id, vanilla.id, 'base')
  await linkNote(erosFlame.id, tonkaBean.id, 'base')
